...
add_action( 'plugins_loaded', function () {
	...
	Quote_Drawer_RFQ::init();
	require_once __DIR__ . '/includes/enqueuer.php';

});

class Quote_Drawer_RFQ {
	...
	public static function render_drawer() {
		...
		<div id="quote-drawer">
			...
			<div class="qd-panel">
				...
				<h2>Your Quote</h2>
				<div id="qd-content"><?php require plugin_dir_path(__FILE__) . '/includes/quote-drawer.php'; ?><a href="/request-a-quote" class="wc-block-components-button wp-element-button">Go to Quote Page</a></div>
			</div>
		</div>
		<?php
	}

 ...
 * Description:       This plugin extends the functionality of Woocommerce Request a Quote
 * Version:           0.0.1
	...
	public static function render_drawer() {
		...
		<div id="quote-drawer">
			...
			<div class="qd-panel">
				...
				<!-- Loading Overlay -->
				<div class="quote-drawer-loading-overlay">
				...
				<div id="qd-content">
					<?php Quote_Drawer::html_structure(); ?>
...
add_action( 'plugins_loaded', function () {
	...
	\Vital\QuoteDrawer\Quote_Drawer_Initial::init();
